...
- **FOCUS VOLGENDE CHAT: de dosis-munt.** `tryPowerZoneTimes_` vouwt Z3 én Z4 samen tot `high`, dus de meetlat telt tempo volledig als kwaliteit terwijl het plan er nul van voorschrijft (gemeten op V1: rust 58 · z2 148 · tempo 0 · drempel 93 · anaeroob 0). Een dosis-trede vermenigvuldigt die munt. Raakt `DOELEN-SPEC` §2A. Verse chat.
