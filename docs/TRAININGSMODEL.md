...
> **DRIE RANDVOORWAARDEN HOREN ONLOSMAKELIJK BIJ M93.** (1) De omrekening geldt ALLEEN bij het doel FTP. De app biedt per doel een ander testprotocol aan en alleen dat ene draagt een omrekening; het conditie-protocol meet hartslagdrift en het klimprotocol is een handmatige vergelijking met vorige pogingen. (2) De curve geeft ook voor een rustige duurrit een keurig getal — gemeten geval: een Z2-rit zou een verlaging van 34 procent hebben voorgesteld op een staande drempelwaarde. Zonder rem zegt de app "gemeten" waar niets gemeten is, en dat is M5. Deze randvoorwaarde eiste daarom aanvankelijk een PLAUSIBILITEITSGRENS, te ijken op de echte reeks en nooit in een gesprek te kiezen. **Op 25-08-2026 is die eis VERVALLEN, en wel op grond van een meting.** De rem bleek niet te leggen: een grens ijk je tegen inspanningen waarvan je WEET dat ze maximaal waren, en Daans reeks bevat er geen — over 215 teruggehaalde twintigminutenwaarden vuurt de omrekening precies één keer, op een rit die "FTP build up" heet, en die ene uitkomst valt samen met de schatting die de meetdienst er zelf uit trok. Eén samenval is geen ijkpunt. De band die uit de modellen van de meetdienst zelf viel te trekken bleek op verse gegevens bovendien LEEG. Wat de rem moest tegenhouden is intussen van twee kanten al dichtgezet: de LAGE kant door M94 (alleen omhoog), zodat het Z2-geval hierboven geen voorstel meer oplevert, en de HOGE kant door M10 — de app stelt voor, de renner bevestigt. **De renner IS de plausibiliteitstoets.** Daarom toont het voorstel zijn HERKOMST: welke rit, hoe lang, welk vermogen, welke factor. Zonder die herkomst kan hij de toets niet uitvoeren en is de bevestiging een lege klik. HERKOMST-ETIKET van dit vervallen: **BELEID — een Daan-besluit** van 25-08-2026, genomen nadat het ijken van de grens twee ronden lang mislukte. Komt er ooit een reeks MET gemerkte maximale inspanningen, dan is de grens opnieuw te overwegen; tot die tijd zou elk getal hier gekozen zijn en niet gemeten. (3) Pas bij GOEDKEURING is er geijkt; het voorstel alleen ijkt niets (M91).

**M94 (NORM) - Een ONGEPLANDE inspanning stelt de drempelwaarde alleen OMHOOG bij.** Besloten 25-08-2026. Rijdt de renner uit zichzelf diep en volgt daar via M93 een HOGERE drempelwaarde uit, dan mag de app die voorstellen. Volgt er een LAGERE uit, dan stelt zij niets voor. Omlaag bijstellen kan uitsluitend na een inspanning die de renner BEWUST als test is aangegaan. HERKOMST-ETIKET: **BELEID — een Daan-besluit**, geen geijkte drempel.

> **DE GROND.** Geen trainer verlaagt een drempel op een slechte dag. Een lage waarde uit een willekeurige rit bewijst niets: onder je kunnen rijden kan altijd, erboven nooit. Een hoge waarde is dus bewijs en een lage waarde is dat niet, en die asymmetrie zit in de fysiologie en niet in de app. Dit sluit meteen het geval dat M93 randvoorwaarde (2) noemt: een rustige duurrit levert een lage waarde en dus geen voorstel.

> **STATUS: DEZE NORM IS NOG NIET UITVOERBAAR, en dat hoort erbij.** Gemeten op 25-08-2026 dat het onderscheid dat M94 maakt — ONGEPLAND tegenover BEWUST AANGEGAAN — in de opgeslagen gegevens niet te lezen is. Vrijwel elke rit geldt als ongepland, ook een rit die naar zijn naam een testinspanning was, en omgekeerd zou de meest test-achtige rit van de reeks als ongepland worden geweigerd. Zolang dat zo is, klapt M94 dicht tot "alleen omhoog" en bestaat de weg omlaag in de praktijk niet. Dat is een BEPERKING van de uitvoering en geen versoepeling van de norm: de app mag niet doen alsof zij het onderscheid maakt (M5). Wat er nodig is om M94 wél uitvoerbaar te maken, staat in het verdict-document van ROADMAP punt 69.
