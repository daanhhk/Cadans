...
// coachFeedback_ narrative (card.narrative), NOOIT hardcoded — ontbreekt → box weglaten. Rendert via
// de gedeelde CoachCallout; de context-marges (marginTop s-4 / marginBottom s-6, afgestemd op de
// knoppen-rij via margin-collapse) worden hier meegegeven zodat de done-render byte-identiek blijft.
