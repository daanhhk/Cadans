...
// sleutelsessie: waar de prikkel deze week nog staat. Huisstijl van het "Wat er zou veranderen"-
// blok in InhaalCard, met dezelfde tokens. Geen Card-wrapper (dit zit ín de dag-detail-Card),
// geen knop, geen eigen kleuren.
//
  ...
  return (
    ...
    >
      ...
      {dagen.length === 0 ? (
        ...
        >
          Deze week staat er geen trainingsdag meer om 'm op te pakken.
        </div>
      ) : (
        dagen.map((d) => (
          <div
