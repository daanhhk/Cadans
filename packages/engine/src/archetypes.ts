...
export const ARCHETYPES: any[] = [
  ...
  // ── Doelen-spec stap 2 (§4): extra sweet-spot-sjablonen voor de dunne band 34-85 min. ──
  {
    id: "sweetspot_3x8",
    structuurtype: "intervals",
    effectTags: ["sweetspot"],
    zone: 4,
    duurRange: [41, 60],
    warmup: { durMin: 7, pctLo: 55, pctHi: 70 },
    core: [
      {
        kind: "int",
        label: "Sweet Spot",
    ...
    focus: "sweet spot",
    eindopmerking:
      "Drie blokken sweet spot — beheersbare prikkel, veel dichtheid.",
  },
  {
    id: "sweetspot_3x6_kort",
    structuurtype: "intervals",
    effectTags: ["sweetspot"],
    zone: 4,
    duurRange: [34, 52],
    ...
    cooldown: { durMin: 4, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Sweet Spot 3×6 kort",
    focus: "sweet spot",
    eindopmerking: "Compacte drie-blokken-sweet-spot voor de korte dag.",
  },
  {
    id: "sweetspot_2x15",
    structuurtype: "intervals",
    ...
    cooldown: { durMin: 4, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Sweet Spot 2×15",
    focus: "sweet spot",
    eindopmerking: "Twee lange blokken — duurzame sweet-spot-belasting.",
  },
  {
    id: "sweetspot_lage_cadans",
    structuurtype: "intervals",
    effectTags: ["sweetspot"],
    zone: 4,
    duurRange: [41, 60],
    ...
    core: [
      {
        ...
        offMin: 3,
        offPct: 50,
        note: "Zware versnelling, 60-70 rpm",
      },
    ],
    cooldown: { durMin: 4, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Sweet Spot lage cadans 3×7",
    focus: "sweet spot",
    eindopmerking:
      "Lage cadans — extra kracht-prikkel bij dezelfde sweet-spot-dosis.",
  },
  {
    id: "sweetspot_lage_cadans_lang",
    structuurtype: "intervals",
    effectTags: ["sweetspot"],
    zone: 4,
    duurRange: [56, 85],
    ...
    cooldown: { durMin: 4, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Sweet Spot lage cadans 3×12",
    focus: "sweet spot",
    eindopmerking:
      "Lange lage-cadans-blokken — kracht plus duurzame drempelnabijheid.",
  },
  // ── VO2 ──
  {
    id: "vo2_long",
  ...
  // ── Doelen-spec stap 2 (§4): extra vo2-sjablonen voor de band 42-75 min. ──
  {
    id: "vo2_4x4",
    structuurtype: "intervals",
    effectTags: ["vo2"],
    zone: 5,
    duurRange: [42, 70],
    warmup: { durMin: 10, pctLo: 55, pctHi: 80 },
    core: [
      {
        kind: "int",
        label: "VO2 4×4",
    ...
    focus: "vo2max",
    eindopmerking:
      "Klassieke vier-minuten-blokken — het kloppend hart van VO2max.",
  },
  {
    id: "vo2_60_30",
    structuurtype: "microburst",
    ...
    core: [
      {
        ...
        offSec: 30,
        offPct: 50,
        note: "De 30 seconden zijn geen rust, blijf doortrappen",
      },
      {
        kind: "steady",
        label: "Herstel",
    ...
    naam: "VO2max 60/30",
    focus: "vo2 microburst",
    eindopmerking: "Langere microbursts — vo2-tijd opbouwen met korte pauzes.",
  },
  {
    id: "vo2_30_15_sets",
    structuurtype: "microburst",
  ...
  // ── Doelen-spec stap 2 (§4): extra drempel-sjablonen voor de dunne band 33-68 min. ──
  {
    id: "threshold_3x6",
    structuurtype: "intervals",
    effectTags: ["drempel"],
    zone: 4,
    duurRange: [40, 58],
    warmup: { durMin: 8, pctLo: 55, pctHi: 78 },
    core: [
      {
        kind: "int",
        label: "Drempel",
    ...
    focus: "threshold",
    eindopmerking:
      "Korte drempelblokken, hoge dichtheid — houdt de scherpte in de winter.",
  },
  {
    id: "threshold_2x12",
    structuurtype: "intervals",
    ...
    focus: "threshold",
    eindopmerking:
      "Twee lange blokken net onder FTP — duurzame drempelbelasting.",
  },
  {
    id: "threshold_ou_kort",
    structuurtype: "intervals",
    effectTags: ["drempel"],
    zone: 4,
    duurRange: [37, 56],
    warmup: { durMin: 9, pctLo: 55, pctHi: 75 },
    core: [
      { kind: "steady", label: "Over", durMin: 2, pct: 104, note: "Boven FTP" },
      {
        kind: "steady",
        label: "Under",
        durMin: 3,
        pct: 93,
        note: "Onder FTP — klaren",
      },
      { kind: "steady", label: "Over", durMin: 2, pct: 104, note: "Boven FTP" },
      { kind: "steady", label: "Under", durMin: 3, pct: 93, note: "Onder FTP" },
      {
        kind: "steady",
        label: "Herstel",
        durMin: 3,
    ...
    cooldown: { durMin: 5, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Drempel over-under kort",
    focus: "lactate clearance",
    eindopmerking:
      "Compacte over-under — klaren onder druk in een korte sessie.",
  },
  {
    id: "threshold_ladder_kort",
    structuurtype: "intervals",
    effectTags: ["drempel"],
    zone: 4,
    duurRange: [40, 60],
    warmup: { durMin: 8, pctLo: 55, pctHi: 78 },
    core: [
      { kind: "steady", label: "Blok", durMin: 5, pct: 99, note: "Op FTP" },
      {
        kind: "steady",
        label: "Herstel",
        durMin: 3,
        pct: 55,
        note: "Easy tussen de blokken",
      },
      { kind: "steady", label: "Blok", durMin: 7, pct: 100, note: "Op FTP" },
      {
        kind: "steady",
        label: "Herstel",
        durMin: 3,
      ...
      },
      {
        ...
        durMin: 9,
        pct: 98,
        note: "Op FTP, afsluiten",
      },
    ],
    cooldown: { durMin: 5, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Drempel ladder 5-7-9",
    focus: "threshold",
    eindopmerking: "Oplopende blokken — geleidelijk langer op de drempel.",
  },
  {
    id: "threshold_4x8_seiler",
    structuurtype: "intervals",
    effectTags: ["drempel"],
    zone: 4,
    duurRange: [58, 85],
    warmup: { durMin: 12, pctLo: 55, pctHi: 80 },
    core: [
      {
        kind: "int",
        label: "Drempel",
        ...
        offMin: 2,
        offPct: 55,
        note: "Gelijkmatig, de laatste even hard als de eerste",
      },
    ],
    cooldown: { durMin: 6, pctLo: 45, pctHi: 55 },
    fill: { zone: 2, pct: 65 },
    naam: "Drempel 4×8",
    focus: "threshold",
    eindopmerking: "Seiler-klassieker — vier volle blokken net boven FTP.",
  },
  {
    id: "threshold_4x10",
    structuurtype: "intervals",
